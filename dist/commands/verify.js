...
async function collectVerificationData(programId) {
    // Get IDL
...
async function collectSourceFiles() {
    ...
    // Collect Cargo.toml
    if ((0, fs_1.existsSync)('programs/Cargo.toml')) {
        files.push({
            path: 'programs/Cargo.toml',
            content: (0, fs_1.readFileSync)('programs/Cargo.toml', 'utf8')
        });
    }
    // Collect Anchor.toml
    if ((0, fs_1.existsSync)('Anchor.toml')) {
        files.push({
            path: 'Anchor.toml',
            content: (0, fs_1.readFileSync)('Anchor.toml', 'utf8')
        });
    }
    return files;
}
